...
$\mathbb{E}(\hat{t}_{h1}-\hat{t}_{h2})^2=({t}_{h1}-{t}_{h2})^2+N_{h1}^2(1-1/ N_{h1}) S^2_{Uh1}+N_{h2}^2(1-1/ N_{h2}) S^2_{Uh2}$

Por lo tanto, la esperanza de la suma sobre todos los estratos, que coincide con la esperanza de $\hat{V}_1(\hat{t}_y)$ es

$\sum_{h=1}^{H/2}\mathbb{E} (\hat{t}_{h1}-\hat{t}_{h2})^2=\mathbb{E}(\hat{V}_1(\hat{t}_y))= \sum_{h=1}^{H} N_{h}^2(1-1/ N_{h}) S^2_{Uh}+\sum_{h=1}^{H/2}({t}_{h1}-{t}_{h2})^2$
