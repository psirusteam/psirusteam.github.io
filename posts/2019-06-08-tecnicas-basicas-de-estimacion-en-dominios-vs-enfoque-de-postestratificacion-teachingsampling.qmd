...
**$\Var(\hat{t}_{d \pi})=\sum\sum_{U_d}\Delta_{kl}\frac{y_k}{\pi_k}\frac{y_l}{\pi_l}$**
...
**$\Var_{MAS}(\hat{t}_{d \pi})=\frac{N^2_d}{n_d}(1-\frac{n_d}{N_d}) S^2_{y_{U_d}}$**
