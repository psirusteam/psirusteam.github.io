...
Dado que *T*es insesgado, también es asintóticamente insesgado. Sin embargo, dado que la varianza de*T* es $\operatorname{Var}(T)=2\neq 0$, no es consistente. Por supuesto, lo anterior se verifica rápidamente cuando se nota que

$\Pr(|T-\mu|>\varepsilon)=1-\Pr(-\varepsilon<T-\mu<\varepsilon)$.
